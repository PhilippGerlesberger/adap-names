...
describe("Basic StringName function tests", () => {
  ...
  describe("test insert", () => {
    it("test insert 0", () => {
      ...
      let m: Name = n.insert(1, "cs");
      expect(n.getNoComponents()).toBe(3);
      expect(m.getNoComponents()).toBe(4);
      expect(n.asString()).toBe("oss.fau.de");
      expect(m.asString()).toBe("oss.cs.fau.de");
    });
    it("test insert 1", () => {
      let n: Name = new StringName("oss.fau.de");
      let m: Name = n.insert(0, "");
      expect(n.getNoComponents()).toBe(3);
      expect(m.getNoComponents()).toBe(4);
      expect(n.asString()).toBe("oss.fau.de");
      expect(m.asString()).toBe(".oss.fau.de");
    });
    it("test insert 2", () => {
      let n: Name = new StringName("oss.fau.de");
      let m: Name = n.insert(1, "");
      expect(n.getNoComponents()).toBe(3);
      expect(m.getNoComponents()).toBe(4);
      expect(n.asString()).toBe("oss.fau.de");
      expect(m.asString()).toBe("oss..fau.de");
    ...
    it("test insert 4", () => {
      ...
      let m: Name = n.insert(1, "cs.fa\\#u");
      expect(m.asDataString()).toBe("oss.cs\\.fa#u.de");
    });
    it("test insert 5", () => {
      let n: Name = new StringName("", );
      n = n.insert(0, "de");
  ...
  describe("test append", () => {
    it("test append 0", () => {
      let n: Name = new StringName("oss.cs.fau");
      let m: Name = n.append("de");
      expect(n.getNoComponents()).toBe(3);
      expect(n.asString()).toBe("oss.cs.fau");
      expect(n.asDataString()).toBe("oss.cs.fau");
      expect(m.getNoComponents()).toBe(4);
      expect(m.asString()).toBe("oss.cs.fau.de");
      expect(m.asDataString()).toBe("oss.cs.fau.de");
    });
    it("test append 1", () => {
      ...
      expect(m.getNoComponents()).toBe(3);
      expect(m.asString()).toBe("oss.cs.");
    });
    it("test append 2", () => {
      let n: Name = new StringName("");
      let m: Name = n.append("");
  ...
  describe("test concat", () => {
    it("test concat 0", () => {
      ...
      let k: Name = n.concat(m);
      expect(n.getNoComponents()).toBe(2);
      expect(m.getNoComponents()).toBe(2);
      expect(k.asString()).toBe("oss.cs#fau#cs.fau\\#de#com,io");
      expect(k.asDataString()).toBe("oss\\.cs.fau.cs\\.fau\\\\.de#com,io");
    });
    it("test concat 1", () => {
      let n: Name = new StringName("oss.cs#fau", '#');
      ...
      expect(n.getNoComponents()).toBe(2);
      expect(m.getNoComponents()).toBe(2);
      expect(k.asString()).toBe("oss.cs#fau#de#com#org,io");
      expect(k.asDataString()).toBe("oss\\.cs.fau.de.com#org,io");
    });
    it("test concat 2", () => {
      let n: Name = new StringName("", '#');
      let m: Name = new StringName("de,com#org\\,io", ',');
      ...
      expect(n.getNoComponents()).toBe(1);
      expect(m.getNoComponents()).toBe(2);
      expect(k.asString()).toBe("#de#com#org,io");
      expect(k.asDataString()).toBe(".de.com#org,io");
    });
    it("test concat 3", () => {
      let n: Name = new StringName("oss.cs#fau", '#');
      ...
      expect(k.getNoComponents()).toBe(3);
      expect(k.asString()).toBe("oss.cs#fau#");
      expect(k.asDataString()).toBe("oss\\.cs.fau.");
    });
    it("test concat 4", () => {
      let n: Name = new StringName("", '#');
      let m: Name = new StringName("", ',');    
...
describe("Basic StringArrayName function tests", () => {
  ...
  describe("test insert", () => {
    ...
    it("test insert 11", () => {
      let n: Name = new StringArrayName([""], '.');
      let m: Name = n.insert(1, "test");
      expect(m.getNoComponents()).toBe(2);
      expect(m.asString()).toBe(".test");
    });
    ...
    it("test insert 14", () => {
      ...
      n = n.remove(0);
      expect(n.getNoComponents()).toBe(0);
      let m: Name = n.insert(0, "cs");
      expect(m.getNoComponents()).toBe(1);
      expect(m.asString()).toBe("cs");
    });
  });
